        ...
        <form action="<?= ROOT ?>/company/addNewAd" method="POST">
            <div class="details">
                ...
                <div class="compdetails">
                    ...
                    <textarea name="other_qualifications" rows="4" cols="50"
                              placeholder="Enter additional qualifications or descriptions..."
                              class="qualification-textarea"></textarea>
                    <br>
                    ...
                    <select name="scale" required>
                        <option value="" selected hidden>Select Scale</option>
