...
class AdvertisementRepository
{
    ...
    public function save($position, $requirements, $no_of_intern, $working_mode, $from_date, $to_date, $company_id, $qualification, $other_qualifications, $status, $no_of_cvs_required, $scale)
    {
    ...
    public function getAllAdvertisements(): array
    {
        ...
        while ($row = $result->fetch_assoc()) {
            $advertisement = new AdvertisementModel(
                ...
                $row['scale'] // Include the 'scale' field
            );
...
//    {
//        $companyId = $_SESSION['userId'];
//        $sql = "SELECT * FROM company_ad WHERE company_id = :i;
//        $stmt = $this->conn->prepare($sql);
//
//        $stmt->bind_param('i', $companyId);
//        $stmt->execute();
